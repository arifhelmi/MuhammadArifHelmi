			...
			<section className="portfolio-hero portfolio-shell" id="home">
				...
				<Reveal className="portfolio-hero-copy">
					...
					<p className="portfolio-hero-role">
						...
						<span>with Backend Specialization.</span>
					</p>
				...
				<Reveal className="portfolio-terminal-wrap" delay={140}>
					<div className="portfolio-terminal" aria-label="Developer profile summary">
						...
						<div className="portfolio-terminal-body">
							...
							<p><span className="terminal-muted">02</span>&nbsp;&nbsp;focus: <span className="terminal-string">"backend systems"</span>,</p>
							<p><span className="terminal-muted">03</span>&nbsp;&nbsp;stack: [<span className="terminal-string">"Node.js"</span>, <span className="terminal-string">"TypeScript"</span>],</p>
							<p><span className="terminal-muted">04</span>&nbsp;&nbsp;delivery: <span className="terminal-string">"production-ready"</span>,</p>
